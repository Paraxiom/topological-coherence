...
\noindent\textbf{Keywords:} toroidal logit bias; spectral gap; hallucination; language models; Tonnetz topology; graph Laplacian; coherence; doubly-stochastic constraint
...
S.C. conceived the theoretical framework, designed and executed all experiments, and wrote the manuscript.

\section*{Funding}
This research received no external funding.

\section*{Data Availability Statement}
All code, configurations, and experimental results are publicly available at \url{https://github.com/Paraxiom/topological-coherence}. An interactive demo is available at \url{https://huggingface.co/spaces/paraxiom/topological-coherence}.
